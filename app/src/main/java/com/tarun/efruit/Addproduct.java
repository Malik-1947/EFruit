...
public class Addproduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catResult = cat.getStringExtra("category");
        System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!" + catResult);
        System.out.println("cat" + catResult);
        //Picture,name,quantity,price
        reference = FirebaseStorage.getInstance().getReference("Product Images");
